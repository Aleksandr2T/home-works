...
// }else if(visitorAge >= 12 && visitorAge <= 18 || isWithParents){
//   console.log('Проход разрешен 1');
// }else if(visitorAge <= 60 && visitorAge >= 80 || isWithParents){
//   console.log('Проход разрешен 2');
// }else if(visitorAge >= 80 && visitorAge <= 12){
